from yann_agent.player import extract_features
from os import path 
import torch 
...
class Team:
    ...
    def __init__(self):
        ...
        self.model0 = torch.jit.load(path.join(path.dirname(path.abspath(__file__)), 'yoshua_agent0.pt'))
        self.model1 = torch.jit.load(path.join(path.dirname(path.abspath(__file__)), 'yoshua_agent1.pt'))
